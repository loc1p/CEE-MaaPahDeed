...
ถ้าเป็นคอร์ดพื้นฐาน แอปจะใช้ local chord shape เพื่อให้โหลดเร็ว ถ้าเป็นคอร์ดที่ไม่มีใน local shape list แอปจะเรียก backend เพื่อดึง chord shape จาก All Guitar Chords แล้วนำมาวาดบน fretboard โดยแสดงทั้งตำแหน่งนิ้ว สายเปิด และวงสีแดง/X สำหรับสายที่ไม่ควรเล่น
...
3. โชว์ target chord
4. โชว์ fretboard guide ที่มีตำแหน่งนิ้ว วงสีแดง/X ของ muted strings และ open-string marker
...
- หลัง deploy ให้ใช้ลิงก์ `https://project-5101d58b-03f9-4d7e-a71.web.app/` และ hard refresh ถ้า browser ยังแสดงไฟล์เก่า
